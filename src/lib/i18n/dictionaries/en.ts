export const en = {
  ...
  home: {
    ...
    work: {
      title: "Selected work",
      subtitle: "Live products you can open.",
      name: "Nur Bilgi",
      description: "Web product for Islamic knowledge, including a Q&A assistant, Quran, prayer times, and related tools.",
      role: "Live at nurbilgi.com, with iOS and Android apps on the App Store and Google Play.",
    ...
    about: {
      title: "About Rhenvox",
      body: "Rhenvox LTD is a UK software company operated from Türkiye by its founder, Merve Ekşi. It works with clients globally.",
      link: "More about Rhenvox"
    },
    cta: {
      title: "Have a product to build?",
      body: "Tell Rhenvox what you want to build on the web or on mobile. You can request a quote, or reach the company by phone or WhatsApp.",
  ...
  about: {
    ...
    subtitle: "Rhenvox LTD is registered in the United Kingdom, operated from Türkiye, and works with clients globally.",
  ...
  workPage: {
    ...
    visitCoguid: "Visit CoGuide",
    coguidSummary: "CoGuide is a live product for source-backed answers to company-formation questions.",
    imagePending: "Image to be added",
    ...
    status: "Status",
    statusValue: "Live on the web, App Store, and Google Play",
    summary: "A live product at nurbilgi.com, with iOS and Android apps on the App Store and Google Play.",
  ...
  nurBilgi: {
    ...
    overview: "Nur Bilgi is a knowledge product for Islamic reference material and related tools. The web product is live at nurbilgi.com. The iOS and Android apps are on the App Store and Google Play. Rhenvox built the web application, the React Native mobile application, and the .NET API behind them.",
    ...
    liveBody: "The web product is live at nurbilgi.com. The iOS app is on the App Store and the Android app is on Google Play.",
  ...
  contact: {
    ...
    subtitle: "Request a quote for a web or mobile product, or reach Rhenvox by phone or WhatsApp.",
    quoteTitle: "Request a quote",
    quoteBody: "Describe the web or mobile product you want built. Sending opens your email app. This site does not store the message.",
    quoteName: "Name",
    quoteEmail: "Email",
    quoteProduct: "What do you want built?",
    quoteWeb: "Web",
    quoteMobile: "Mobile",
    quoteBoth: "Web and mobile",
    quoteMessage: "What should Rhenvox know?",
    quoteSubmit: "Send quote request",
    quoteNote: "The message goes to hello@rhenvox.com from your own email app.",
    emailTitle: "Email",
